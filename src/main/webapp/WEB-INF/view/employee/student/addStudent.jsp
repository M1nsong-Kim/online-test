	...
	<main id="main" class="main">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="card">
		            <div class="card-body">
		              <h5 class="card-title">학생 등록</h5>
					  <div>${errorMsg}</div>
		              <form method="post" action="${pageContext.request.contextPath}/employee/student/addStudent" id="form" class="my-5">
		                <div class="row mb-3">
		                ...
		                <div class="row mb-3">
		                  ...
		                  <div class="col-sm-10">
		                    <input type="password" name="studentPw" id="studentPw" class="form-control">
		                  </div>
		                </div>
		                <div class="row mb-3">
