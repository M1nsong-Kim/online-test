			...
			<div class="col-lg-8">
				<div class="card">
		            <div class="card-body">
		              ...
		              <form method="post" action="${pageContext.request.contextPath}/teacher/test/addQuestion" id="form" class="my-5">
		              	<input type="hidden" name="testNo" value="${testNo}">
		                <div class="row mb-3">
		                  <label for="inputEmail3" class="col-sm-2 col-form-label">문제번호</label>
		                  <div class="col-sm-10">
		                    <input type="number" name="questionIdx" id="questionIdx" class="form-control">
		                  </div>
		                </div>
		                <div class="row mb-3">
